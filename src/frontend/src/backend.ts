...
export class Backend implements backendInterface {
    ...
    async getUserByUniqueId(arg0: string): Promise<{
        userId: Principal;
        analytics: {
            tasksCompleted: bigint;
            totalSubmissions: bigint;
        ...
        if (this.processError) {
            try {
                const result = await this.actor.getUserByUniqueId(arg0);
    ...
    async updatePaymentStatus(arg0: bigint, arg1: Variant_transferred_approved_declined_inPayment): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updatePaymentStatus(arg0, to_candid_variant_n36(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateTask(arg0: bigint, arg1: string, arg2: Blob | null, arg3: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateTask(arg0, arg1, to_candid_opt_n37(this._uploadFile, this._downloadFile, arg2), arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_BankDetails]): BankDetails | null {
...
function from_candid_opt_n32(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Blob]): Blob | null {
    return value.length === 0 ? null : value[0];
}
function from_candid_opt_n34(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [{
    ...
    return value.length === 0 ? null : from_candid_record_n35(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_record_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        bankDetails: record_opt_to_undefined(from_candid_opt_n21(_uploadFile, _downloadFile, value.bankDetails)),
        coinBalance: value.coinBalance,
        userId: value.userId,
        isBlocked: value.isBlocked,
        uniqueId: record_opt_to_undefined(from_candid_opt_n22(_uploadFile, _downloadFile, value.uniqueId)),
        tasksCompleted: value.tasksCompleted,
        email: value.email,
        totalSubmissions: value.totalSubmissions,
        lastLogin: record_opt_to_undefined(from_candid_opt_n23(_uploadFile, _downloadFile, value.lastLogin))
    };
}
...
function from_candid_record_n35(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        userId: value.userId,
        analytics: from_candid_record_n33(_uploadFile, _downloadFile, value.analytics),
        profile: from_candid_UserProfile_n25(_uploadFile, _downloadFile, value.profile)
    };
}
...
function to_candid_opt_n37(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Blob | null): [] | [_Blob] {
...
function to_candid_variant_n36(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Variant_transferred_approved_declined_inPayment): {
    transferred: null;
} | {
    approved: null;
} | {
